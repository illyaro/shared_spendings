...
fn main() {
    ...
    let dt_from = chrono::NaiveDateTime::parse_from_str("2025-01-01T00:00:00", "%Y-%m-%dT%H:%M:%S").unwrap();
    let dt_to = chrono::NaiveDateTime::parse_from_str("2025-01-31T23:59:59", "%Y-%m-%dT%H:%M:%S").unwrap();
